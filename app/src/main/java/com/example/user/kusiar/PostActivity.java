...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SelectPostImage = (ImageButton) findViewById(R.id.post_select_image);
...
//                    loadingBar.dismiss();
        ...
        UsersRef.child("currentUserID").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    PostsRef.child(current_user_id + postRandomName).setValue(postsMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==Gallery_Pick && resultCode==RESULT_OK && data!=null) {
            imageUri=data.getData(); SelectPostImage.setImageURI(imageUri);
        }
    }
