...
{
    private EditText UserUsername, UserFullname, UserCountry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserUsername = (EditText) findViewById(R.id.setup_username);
            ...
            UsersRef.updateChildren(userMap).addOnCompleteListener(new OnCompleteListener()
            {
                ...
                public void onComplete(@NonNull Task task)
                {
                    if (task.isSuccessful())
                    {
                        ...
                        Toast.makeText(SetupActivity.this, "Created successfully", Toast.LENGTH_LONG).show();
                        loadingBar.dismiss();
                    }
